...
namespace TestRepo.Repository.Migrations
{
    ...
    [Migration("20260328133234_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestRepo.Repository.Entity.ProductCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TestRepo.Repository.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1b9746b6-c51e-48e1-8126-652ff09fde28"),
            ...
            modelBuilder.Entity("TestRepo.Repository.Entity.ProductCategory", b =>
                {
                    b.HasOne("TestRepo.Repository.Entity.Category", "Category")
                        .WithMany("ProductCategories")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TestRepo.Repository.Entity.Product", "Product")
                        .WithMany("ProductCategories")
